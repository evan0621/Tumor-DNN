...
batch_size = 1326
lr = 0.001
train_data = Dataset(txtdir='/home/lab70636/Datasets/Ultrasound_tumor/good_good_data/train.txt')
val_data = Dataset(txtdir='/home/lab70636/Datasets/Ultrasound_tumor/good_good_data/val.txt')
...
for epoch in range(epochs):
    ...
    if epoch != 0 and (epoch + 1) % 10 == 0:
        ...
        bestname = save_dir + 'best.pth'
        if avg_vloss <= minloss:
            minloss = avg_vloss
            torch.save(net, bestname)
